...
public class ToastUtils {
    ...
    private static void check() {
        if (sContext == null) {
            throw new NullPointerException(
                    "Must  call ToastUtils.init(Context context) first");
        }
    }
    ...
    public static void showShort(int resId) {
        check();
        ToastCompat.makeText(sContext, resId, Toast.LENGTH_SHORT).show();
    }


    public static void showShort(String message) {
        check();
        ToastCompat.makeText(sContext, message, Toast.LENGTH_SHORT).show();
    }


    public static void showLong(int resId) {
        check();
        ToastCompat.makeText(sContext, resId, Toast.LENGTH_LONG).show();
    }


    public static void showLong(String message) {
        check();
        ToastCompat.makeText(sContext, message, Toast.LENGTH_LONG).show();
    }


    public static class ToastCompat extends Toast{
